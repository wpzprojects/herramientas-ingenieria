...
`tools/verify_ampacidad_subterranea.html` hace lo mismo con la pantalla de Ampacidad subterránea (IEC 60287-1-1 contra una versión independiente: monopolar/tripolar, puestas a tierra, banco de ductos con imágenes de Kennelly, reporte y fórmulas).
