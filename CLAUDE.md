...
- Ocupación de ductos (2026-09-19) sigue el mismo patrón (tarjetas, iconos, relleno, info «i», reporte y fórmulas KaTeX). Dos tarjetas:
  «Tubería» (icono `cylinder`; tipo, diámetro nominal y diámetro interno del catálogo con «Manual») y una tarjeta «Conductor tipo N» (2026-09-21: sin guión ni plural; el REPORTE de texto aún dice «Conductores — Tipo N:»)
...
- Cada cambio en archivos del shell exige subir `CACHE_VERSION` de `sw.js` (hoy v230); en el celular hay que cerrar la app y
